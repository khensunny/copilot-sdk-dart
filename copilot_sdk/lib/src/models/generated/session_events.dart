...
sealed class SessionEvent {
  ...
  factory SessionEvent.fromJson(Map<String, dynamic> json) {
    ...
    if (json['ephemeral'] == true && json['type'] == 'session.snapshot_rewind') {
    ...
    if (json['ephemeral'] == true && json['type'] == 'pending_messages.modified') {
    ...
    if (json['ephemeral'] == true && json['type'] == 'assistant.reasoning_delta') {
    ...
    if (json['ephemeral'] == true && json['type'] == 'assistant.message_delta') {
    ...
    if (json['ephemeral'] == true && json['type'] == 'tool.execution_partial_result') {
      constMatches.add(ToolExecutionPartialResult.fromJson);
      constMatchNames.add('ToolExecutionPartialResult');
    }
    if (json['ephemeral'] == true && json['type'] == 'tool.execution_progress') {
    ...
    if (constMatches.length > 1) {
      throw ArgumentError('Ambiguous SessionEvent variant matched const heuristics: ${constMatchNames.join(', ')}');
    }
    ...
    throw ArgumentError('No SessionEvent variant matched heuristics (keys: ${sortedKeys.join(', ')}).');
  }
...
class Info extends SessionEventDataLegacySessionTimeline {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp1 != 'info') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'info' but found " + actualp1 + '.');
    }
  }
}
...
class SessionStart extends SessionEvent {
  ...
  factory SessionStart.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionStartData.fromJson((json['data'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.start') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.start' but found " + actualp5 + '.');
    }
  }
}
...
class SessionResumeData {
  ...
  factory SessionResumeData.fromJson(Map<String, dynamic> json) {
    ...
    final context = json['context'] == null
        ? null
        : SessionResumeDataContext.fromJson((json['context'] as Map).cast<String, dynamic>());
    remaining.remove('context');
    final eventCount = (json['eventCount'] as num).toDouble();
...
class SessionResume extends SessionEvent {
  ...
  factory SessionResume.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionResumeData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.resume') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.resume' but found " + actualp5 + '.');
    }
  }
}
...
class SessionError extends SessionEvent {
  ...
  factory SessionError.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionErrorData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.error') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.error' but found " + actualp5 + '.');
    }
  }
}
...
class SessionIdle extends SessionEvent {
  ...
  factory SessionIdle.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionIdleData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp1 = value1;
    if (!actualp1) {
      throwValidationError(ptr1, 'const', 'Expected value equal to true but found $actualp1.');
    }
    final ptr2 = appendJsonPointer(pointer, 'id');
    final value2 = id;
    context?.markProperty(pointer, 'id');
    ...
    if (actualp5 != 'session.idle') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.idle' but found " + actualp5 + '.');
    }
  }
}
...
class SessionInfo extends SessionEvent {
  ...
  factory SessionInfo.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionInfoData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.info') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.info' but found " + actualp5 + '.');
    }
  }
}
...
class SessionModelChange extends SessionEvent {
  ...
  factory SessionModelChange.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionModelChangeData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.model_change') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.model_change' but found " + actualp5 + '.');
    }
  }
}
...
class DeveloperContentArrayItem {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp1 = value1;
    if (actualp1 != 'text') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'text' but found " + actualp1 + '.');
    }
  }
}
  ...
  factory DeveloperContent.fromJson(dynamic json) {
    ...
    if (json is List)
      return DeveloperContentArray(
        json.map((e) => DeveloperContentArrayItem.fromJson((e as Map).cast<String, dynamic>())).toList(),
      );
    throw ArgumentError('Invalid DeveloperContent value type: ${json.runtimeType}');
  }
...
class Developer extends SessionImportLegacyDataLegacySessionChatMessage {
  ...
  factory Developer.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final content = DeveloperContent.fromJson((json['content'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    try {
      ...
      final constraintp0v0_1 = (jsonp0 as List)
          .map((e) => DeveloperContentArrayItem.fromJson((e as Map).cast<String, dynamic>()))
          .toList();
    ...
    if (actualp2 != 'developer') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'developer' but found " + actualp2 + '.');
    }
  }
}
  ...
  factory SystemContent.fromJson(dynamic json) {
    ...
    if (json is List)
      return SystemContentArray(
        json.map((e) => SystemContentArrayItem.fromJson((e as Map).cast<String, dynamic>())).toList(),
      );
    throw ArgumentError('Invalid SystemContent value type: ${json.runtimeType}');
  }
...
class System extends SessionImportLegacyDataLegacySessionChatMessage {
  ...
  factory System.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final content = SystemContent.fromJson((json['content'] as Map).cast<String, dynamic>());
    remaining.remove('content');
    final name = json['name'] as String?;
    remaining.remove('name');
    final role = json['role'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    try {
      final context = constraintp0c0_1;
      final constraintp0v0_1 = (jsonp0 as List)
          .map((e) => SystemContentArrayItem.fromJson((e as Map).cast<String, dynamic>()))
          .toList();
      final lenp0c0b1 = constraintp0v0_1.length;
      final evaluatedp0c0b1 = List<bool>.filled(lenp0c0b1, false);
      for (var i = 0; i < lenp0c0b1; i++) {
    ...
    final actualp2 = value2;
    if (actualp2 != 'system') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'system' but found " + actualp2 + '.');
    }
  }
}
...
class ImageUrlImageUrl {
  ...
  factory ImageUrlImageUrl.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final detail = json['detail'] == null ? null : ImageUrlImageUrlDetailJson.fromJson(json['detail'] as String);
...
class ImageUrl extends UserContentArrayItem {
  ...
  factory ImageUrl.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final imageUrl = ImageUrlImageUrl.fromJson((json['image_url'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp1 != 'image_url') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'image_url' but found " + actualp1 + '.');
    }
  }
}
...
class InputAudioInputAudio {
  ...
  factory InputAudioInputAudio.fromJson(Map<String, dynamic> json) {
    ...
    remaining.remove('data');
    final format = InputAudioInputAudioFormatJson.fromJson(json['format'] as String);
...
class InputAudio extends UserContentArrayItem {
  ...
  factory InputAudio.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final inputAudio = InputAudioInputAudio.fromJson((json['input_audio'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp1 != 'input_audio') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'input_audio' but found " + actualp1 + '.');
    }
  }
}
...
class File extends UserContentArrayItem {
  ...
  factory File.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final file = FileFile.fromJson((json['file'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp1 = value1;
    if (actualp1 != 'file') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'file' but found " + actualp1 + '.');
    }
  }
}
...
sealed class UserContentArrayItem {
  ...
  factory UserContentArrayItem.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final constMatches = <UserContentArrayItem Function(Map<String, dynamic>)>[];
    final constMatchNames = <String>[];
    if (json['type'] == 'text') {
    ...
    final requiredMatches = <UserContentArrayItem Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    ...
    throw ArgumentError('No UserContentArrayItem variant matched heuristics (keys: ${sortedKeys.join(', ')}).');
  }
  ...
  factory UserContent.fromJson(dynamic json) {
    ...
    if (json is List)
      return UserContentArray(
        json.map((e) => UserContentArrayItem.fromJson((e as Map).cast<String, dynamic>())).toList(),
      );
...
class User extends SessionImportLegacyDataLegacySessionChatMessage {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final content = UserContent.fromJson((json['content'] as Map).cast<String, dynamic>());
    remaining.remove('content');
    final name = json['name'] as String?;
    remaining.remove('name');
    final role = json['role'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    try {
      final context = constraintp0c0_1;
      final constraintp0v0_1 = (jsonp0 as List)
          .map((e) => UserContentArrayItem.fromJson((e as Map).cast<String, dynamic>()))
          .toList();
      final lenp0c0b1 = constraintp0v0_1.length;
      final evaluatedp0c0b1 = List<bool>.filled(lenp0c0b1, false);
      for (var i = 0; i < lenp0c0b1; i++) {
        ...
        final constraintp0c0b1ic0_0 = context == null ? null : ValidationContext();
        var constraintp0c0b1im0_0 = false;
        try {
          final context = constraintp0c0b1ic0_0;
          final constraintp0c0b1iv0_0 = Text.fromJson((jsonp0c0b1i as Map).cast<String, dynamic>());
          constraintp0c0b1iv0_0.validate(pointer: itemPointer, context: context);
          constraintp0c0b1im0_0 = true;
        } catch (_) {}
        final constraintp0c0b1ic0_1 = context == null ? null : ValidationContext();
        var constraintp0c0b1im0_1 = false;
        try {
          final context = constraintp0c0b1ic0_1;
          final constraintp0c0b1iv0_1 = ImageUrl.fromJson((jsonp0c0b1i as Map).cast<String, dynamic>());
          constraintp0c0b1iv0_1.validate(pointer: itemPointer, context: context);
          constraintp0c0b1im0_1 = true;
        } catch (_) {}
        final constraintp0c0b1ic0_2 = context == null ? null : ValidationContext();
        var constraintp0c0b1im0_2 = false;
        try {
          final context = constraintp0c0b1ic0_2;
          final constraintp0c0b1iv0_2 = InputAudio.fromJson((jsonp0c0b1i as Map).cast<String, dynamic>());
          constraintp0c0b1iv0_2.validate(pointer: itemPointer, context: context);
          constraintp0c0b1im0_2 = true;
        } catch (_) {}
        final constraintp0c0b1ic0_3 = context == null ? null : ValidationContext();
        var constraintp0c0b1im0_3 = false;
        try {
          final context = constraintp0c0b1ic0_3;
          final constraintp0c0b1iv0_3 = File.fromJson((jsonp0c0b1i as Map).cast<String, dynamic>());
          constraintp0c0b1iv0_3.validate(pointer: itemPointer, context: context);
        ...
        if (context != null && constraintp0c0b1im0_0 && constraintp0c0b1ic0_0 != null) {
          context.mergeFrom(constraintp0c0b1ic0_0);
        }
        if (context != null && constraintp0c0b1im0_1 && constraintp0c0b1ic0_1 != null) {
          context.mergeFrom(constraintp0c0b1ic0_1);
        }
        if (context != null && constraintp0c0b1im0_2 && constraintp0c0b1ic0_2 != null) {
          context.mergeFrom(constraintp0c0b1ic0_2);
        }
        if (context != null && constraintp0c0b1im0_3 && constraintp0c0b1ic0_3 != null) {
    ...
    final actualp2 = value2;
    if (actualp2 != 'user') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'user' but found " + actualp2 + '.');
    }
  }
}
...
class Refusal extends SessionEventDataLegacySessionChatMessageContentArrayItem {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp1 = value1;
    if (actualp1 != 'refusal') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'refusal' but found " + actualp1 + '.');
    }
  }
}
...
sealed class SessionEventDataLegacySessionChatMessageContentArrayItem {
  ...
  factory SessionEventDataLegacySessionChatMessageContentArrayItem.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final constMatches = <SessionEventDataLegacySessionChatMessageContentArrayItem Function(Map<String, dynamic>)>[];
    final constMatchNames = <String>[];
    if (json['type'] == 'text') {
    ...
    final requiredMatches = <SessionEventDataLegacySessionChatMessageContentArrayItem Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    if (keys.contains('type') && keys.contains('text')) {
...
sealed class SessionEventDataLegacySessionChatMessageContent {
  ...
  factory SessionEventDataLegacySessionChatMessageContent.fromJson(dynamic json) {
    if (json is String) return SessionEventDataLegacySessionChatMessageContentString(json);
    if (json is List)
      return SessionEventDataLegacySessionChatMessageContentArray(
        json
            .map(
              (e) =>
                  SessionEventDataLegacySessionChatMessageContentArrayItem.fromJson((e as Map).cast<String, dynamic>()),
            )
            .toList(),
      );
    throw ArgumentError('Invalid SessionEventDataLegacySessionChatMessageContent value type: ${json.runtimeType}');
  }
...
class SessionEventDataLegacySessionChatMessageContentString extends SessionEventDataLegacySessionChatMessageContent {
  const SessionEventDataLegacySessionChatMessageContentString(this.value) : super();
  final String value;
...
class SessionEventDataLegacySessionChatMessageContentArray extends SessionEventDataLegacySessionChatMessageContent {
  const SessionEventDataLegacySessionChatMessageContentArray(this.value) : super();
...
class Function$ extends AssistantToolCall {
  const Function$({
  ...
  factory Function$.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final function = FunctionFunction.fromJson((json['function'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp2 != 'function') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'function' but found " + actualp2 + '.');
    }
  }
}
...
class Custom extends AssistantToolCall {
  ...
  factory Custom.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final custom = CustomCustom.fromJson((json['custom'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp2 = value2;
    if (actualp2 != 'custom') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'custom' but found " + actualp2 + '.');
    }
  }
}
...
sealed class AssistantToolCall {
  ...
  factory AssistantToolCall.fromJson(Map<String, dynamic> json) {
    ...
    if (json['type'] == 'function') {
      constMatches.add(Function$.fromJson);
      constMatchNames.add('Function');
    }
    if (json['type'] == 'custom') {
    ...
    final requiredMatches = <AssistantToolCall Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    if (keys.contains('id') && keys.contains('type') && keys.contains('function')) {
      requiredMatches.add(Function$.fromJson);
      requiredMatchNames.add('Function');
    }
    if (keys.contains('id') && keys.contains('type') && keys.contains('custom')) {
    ...
    throw ArgumentError('No AssistantToolCall variant matched heuristics (keys: ${sortedKeys.join(', ')}).');
  }
...
class Assistant extends SessionImportLegacyDataLegacySessionChatMessage {
  ...
  factory Assistant.fromJson(Map<String, dynamic> json) {
    ...
    final audio = json['audio'] == null
        ? null
        : AssistantAudioObject.fromJson((json['audio'] as Map).cast<String, dynamic>());
    remaining.remove('audio');
    final content = json['content'] == null
        ? null
        : SessionEventDataLegacySessionChatMessageContent.fromJson((json['content'] as Map).cast<String, dynamic>());
    remaining.remove('content');
    final functionCall = json['function_call'] == null
        ? null
        : AssistantFunctionCallObject.fromJson((json['function_call'] as Map).cast<String, dynamic>());
    ...
    final toolCalls = json['tool_calls'] == null
        ...
        : (json['tool_calls'] as List)
              .map((e) => AssistantToolCall.fromJson((e as Map).cast<String, dynamic>()))
              .toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    map['role'] = role;
    if (toolCalls != null) map['tool_calls'] = toolCalls!.map((e) => e.toJson()).toList();
    return map;
  }
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (value0 != null) {
      ...
      try {
        final context = constraintp0c0_0;
        final constraintp0v0_0 = AssistantAudioObject.fromJson((jsonp0 as Map).cast<String, dynamic>());
        constraintp0m0_0 = true;
      } catch (_) {}
      final constraintp0c0_1 = context == null ? null : ValidationContext();
      var constraintp0m0_1 = false;
    ...
    if (value1 != null) {
      ...
      try {
        ...
        final constraintp1v0_0 = SessionEventDataLegacySessionChatMessageContent.fromJson(
          (jsonp1 as Map).cast<String, dynamic>(),
        );
        final jsonp1c0b0 = constraintp1v0_0.toJson();
        final constraintp1c0b0c0_0 = context == null ? null : ValidationContext();
        ...
        final constraintp1c0b0c0_1 = context == null ? null : ValidationContext();
        var constraintp1c0b0m0_1 = false;
        try {
          final context = constraintp1c0b0c0_1;
          final constraintp1c0b0v0_1 = (jsonp1c0b0 as List)
              .map(
                (e) => SessionEventDataLegacySessionChatMessageContentArrayItem.fromJson(
          ...
          for (var i = 0; i < lenp1c0b0c0b1; i++) {
            ...
            final constraintp1c0b0c0b1ic0_0 = context == null ? null : ValidationContext();
            var constraintp1c0b0c0b1im0_0 = false;
            try {
              final context = constraintp1c0b0c0b1ic0_0;
              final constraintp1c0b0c0b1iv0_0 = Text2.fromJson((jsonp1c0b0c0b1i as Map).cast<String, dynamic>());
              constraintp1c0b0c0b1iv0_0.validate(pointer: itemPointer, context: context);
              constraintp1c0b0c0b1im0_0 = true;
            } catch (_) {}
            final constraintp1c0b0c0b1ic0_1 = context == null ? null : ValidationContext();
            var constraintp1c0b0c0b1im0_1 = false;
            try {
              final context = constraintp1c0b0c0b1ic0_1;
              final constraintp1c0b0c0b1iv0_1 = Refusal.fromJson((jsonp1c0b0c0b1i as Map).cast<String, dynamic>());
              constraintp1c0b0c0b1iv0_1.validate(pointer: itemPointer, context: context);
              constraintp1c0b0c0b1im0_1 = true;
            } catch (_) {}
            final constraintp1c0b0c0b1imatches0 = <bool>[constraintp1c0b0c0b1im0_0, constraintp1c0b0c0b1im0_1];
            ...
            if (context != null && constraintp1c0b0c0b1im0_0 && constraintp1c0b0c0b1ic0_0 != null) {
              context.mergeFrom(constraintp1c0b0c0b1ic0_0);
            }
            if (context != null && constraintp1c0b0c0b1im0_1 && constraintp1c0b0c0b1ic0_1 != null) {
        ...
        final constraintp1c0b0matches0 = <bool>[constraintp1c0b0m0_0, constraintp1c0b0m0_1];
        ...
        if (context != null && constraintp1c0b0m0_0 && constraintp1c0b0c0_0 != null) {
          context.mergeFrom(constraintp1c0b0c0_0);
        }
        if (context != null && constraintp1c0b0m0_1 && constraintp1c0b0c0_1 != null) {
    ...
    if (value2 != null) {
      ...
      try {
        ...
        final constraintp2v0_0 = AssistantFunctionCallObject.fromJson((jsonp2 as Map).cast<String, dynamic>());
    ...
    if (actualp5 != 'assistant') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'assistant' but found " + actualp5 + '.');
    }
    ...
    if (value6 != null) {
      ...
      for (var i = 0; i < lenp6; i++) {
        ...
        try {
          ...
          final constraintp6iv0_0 = Function$.fromJson((jsonp6i as Map).cast<String, dynamic>());
        ...
        try {
          ...
          final constraintp6iv0_1 = Custom.fromJson((jsonp6i as Map).cast<String, dynamic>());
          constraintp6iv0_1.validate(pointer: itemPointer, context: context);
          constraintp6im0_1 = true;
        } catch (_) {}
        final constraintp6imatches0 = <bool>[constraintp6im0_0, constraintp6im0_1];
  ...
  factory ToolContent.fromJson(dynamic json) {
    ...
    if (json is List)
      return ToolContentArray(
        json.map((e) => ToolContentArrayItem.fromJson((e as Map).cast<String, dynamic>())).toList(),
      );
...
class Tool extends SessionImportLegacyDataLegacySessionChatMessage {
  ...
  factory Tool.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final content = ToolContent.fromJson((json['content'] as Map).cast<String, dynamic>());
    remaining.remove('content');
    final role = json['role'] as String;
    remaining.remove('role');
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    try {
      final context = constraintp0c0_1;
      final constraintp0v0_1 = (jsonp0 as List)
          .map((e) => ToolContentArrayItem.fromJson((e as Map).cast<String, dynamic>()))
          .toList();
      final lenp0c0b1 = constraintp0v0_1.length;
      final evaluatedp0c0b1 = List<bool>.filled(lenp0c0b1, false);
      for (var i = 0; i < lenp0c0b1; i++) {
    ...
    final actualp1 = value1;
    if (actualp1 != 'tool') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'tool' but found " + actualp1 + '.');
    }
...
sealed class SessionImportLegacyDataLegacySessionChatMessage {
  ...
  factory SessionImportLegacyDataLegacySessionChatMessage.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final constMatches = <SessionImportLegacyDataLegacySessionChatMessage Function(Map<String, dynamic>)>[];
    final constMatchNames = <String>[];
    ...
    final requiredMatches = <SessionImportLegacyDataLegacySessionChatMessage Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    ...
    if (keys.contains('content') && keys.contains('role') && keys.contains('tool_call_id')) {
      requiredMatches.add(Tool.fromJson);
      requiredMatchNames.add('Tool');
    }
    if (keys.contains('content') && keys.contains('role') && keys.contains('name')) {
...
class SessionImportLegacyDataLegacySessionTimelineItem {
  ...
  factory SessionImportLegacyDataLegacySessionTimelineItem.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final id = json['id'] as String;
    remaining.remove('id');
    final timestamp = json['timestamp'] as String;
...
class Copilot extends SessionEventDataLegacySessionTimeline {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp2 = value2;
    if (actualp2 != 'copilot') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'copilot' but found " + actualp2 + '.');
    }
  }
}
...
class Error extends SessionEventDataLegacySessionTimeline {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp1 = value1;
    if (actualp1 != 'error') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'error' but found " + actualp1 + '.');
    }
  }
}
...
class Warning extends SessionEventDataLegacySessionTimeline {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp1 = value1;
    if (actualp1 != 'warning') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'warning' but found " + actualp1 + '.');
    }
  }
}
...
class User2 extends SessionEventDataLegacySessionTimeline {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp1 = value1;
    if (actualp1 != 'user') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'user' but found " + actualp1 + '.');
    }
  }
}

class SessionEventDataLegacySessionTimelineArgumentsObject extends SessionEventDataLegacySessionTimelineArguments {
  ...
  factory SessionEventDataLegacySessionTimelineArgumentsObject.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    ...
    final timeout = (json['timeout'] as num?)?.toDouble();
...
class SessionEventDataLegacySessionTimelineArgumentsObject2 extends SessionEventDataLegacySessionTimelineArguments {
  ...
  factory SessionEventDataLegacySessionTimelineArgumentsObject2.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final delay = (json['delay'] as num?)?.toDouble();
...
class SessionEventDataLegacySessionTimelineArgumentsObject3 extends SessionEventDataLegacySessionTimelineArguments {
  const SessionEventDataLegacySessionTimelineArgumentsObject3({
    required this.delay,
    required this.sessionId,
  }) : super();

  factory SessionEventDataLegacySessionTimelineArgumentsObject3.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final delay = (json['delay'] as num).toDouble();
    remaining.remove('delay');
    final sessionId = json['sessionId'] as String;
...
class SessionEventDataLegacySessionTimelineArgumentsObject4 extends SessionEventDataLegacySessionTimelineArguments {
  const SessionEventDataLegacySessionTimelineArgumentsObject4({
    required this.sessionId,
  }) : super();

  factory SessionEventDataLegacySessionTimelineArgumentsObject4.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final sessionId = json['sessionId'] as String;
    remaining.remove('sessionId');
    final unmatched = Map<String, dynamic>.from(remaining);
...
sealed class SessionEventDataLegacySessionTimelineArguments {
  ...
  factory SessionEventDataLegacySessionTimelineArguments.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final requiredMatches = <SessionEventDataLegacySessionTimelineArguments Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    if (keys.contains('command') && keys.contains('description')) {
      requiredMatches.add(SessionEventDataLegacySessionTimelineArgumentsObject.fromJson);
      requiredMatchNames.add('SessionEventDataLegacySessionTimelineArgumentsObject');
    }
    if (keys.contains('sessionId') && keys.contains('input')) {
      requiredMatches.add(SessionEventDataLegacySessionTimelineArgumentsObject2.fromJson);
      requiredMatchNames.add('SessionEventDataLegacySessionTimelineArgumentsObject2');
    }
    if (keys.contains('sessionId') && keys.contains('delay')) {
      requiredMatches.add(SessionEventDataLegacySessionTimelineArgumentsObject3.fromJson);
      requiredMatchNames.add('SessionEventDataLegacySessionTimelineArgumentsObject3');
    }
    if (keys.contains('sessionId')) {
      requiredMatches.add(SessionEventDataLegacySessionTimelineArgumentsObject4.fromJson);
      requiredMatchNames.add('SessionEventDataLegacySessionTimelineArgumentsObject4');
    }
    if (requiredMatches.length == 1) {
      return requiredMatches.single(json);
    }
...
class View extends SessionEventDataLegacySessionTimelineArguments2 {
  ...
  factory View.fromJson(Map<String, dynamic> json) {
    ...
    final viewRange = json['view_range'] == null ? null : (json['view_range'] as List).map((e) => e).toList();
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp0 != 'view') {
      throwValidationError(ptr0, 'const', "Expected value equal to 'view' but found " + actualp0 + '.');
    }
    ...
    if (value2 != null) {
      ...
      if (value2.length < 2) {
        throwValidationError(ptr2, 'minItems', 'Expected at least 2 items but found ${value2.length}.');
      }
      if (value2.length > 2) {
        throwValidationError(ptr2, 'maxItems', 'Expected at most 2 items but found ${value2.length}.');
      }
    }
  }
}
...
class Create extends SessionEventDataLegacySessionTimelineArguments2 {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp0 = value0;
    if (actualp0 != 'create') {
      throwValidationError(ptr0, 'const', "Expected value equal to 'create' but found " + actualp0 + '.');
    }
...
class StrReplace extends SessionEventDataLegacySessionTimelineArguments2 {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp0 != 'str_replace') {
      throwValidationError(ptr0, 'const', "Expected value equal to 'str_replace' but found " + actualp0 + '.');
    }
...
class Insert extends SessionEventDataLegacySessionTimelineArguments2 {
  ...
  factory Insert.fromJson(Map<String, dynamic> json) {
    ...
    final command = json['command'] as String;
    remaining.remove('command');
    final insertLine = (json['insert_line'] as num).toDouble();
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp0 = value0;
    if (actualp0 != 'insert') {
      throwValidationError(ptr0, 'const', "Expected value equal to 'insert' but found " + actualp0 + '.');
    }
...
sealed class SessionEventDataLegacySessionTimelineArguments2 {
  ...
  factory SessionEventDataLegacySessionTimelineArguments2.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final constMatches = <SessionEventDataLegacySessionTimelineArguments2 Function(Map<String, dynamic>)>[];
    final constMatchNames = <String>[];
    ...
    final requiredMatches = <SessionEventDataLegacySessionTimelineArguments2 Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    if (keys.contains('command') && keys.contains('path')) {
      requiredMatches.add(View.fromJson);
      requiredMatchNames.add('View');
    }
    if (keys.contains('command') && keys.contains('path') && keys.contains('file_text')) {
      requiredMatches.add(Create.fromJson);
      requiredMatchNames.add('Create');
    }
    if (keys.contains('command') && keys.contains('path') && keys.contains('old_str')) {
      requiredMatches.add(StrReplace.fromJson);
      requiredMatchNames.add('StrReplace');
    }
    if (keys.contains('command') && keys.contains('path') && keys.contains('insert_line') && keys.contains('new_str')) {
  ...
  factory ToolCallRequestedArguments.fromJson(dynamic json) {
    if (json is Map<String, dynamic>)
      return ToolCallRequestedArgumentsSessionEventDataLegacySessionTimelineArguments(
        SessionEventDataLegacySessionTimelineArguments.fromJson((json as Map).cast<String, dynamic>()),
      );
    if (json is Map<String, dynamic>)
      return ToolCallRequestedArgumentsSessionEventDataLegacySessionTimelineArguments2(
        SessionEventDataLegacySessionTimelineArguments2.fromJson((json as Map).cast<String, dynamic>()),
      );
    throw ArgumentError('Invalid ToolCallRequestedArguments value type: ${json.runtimeType}');
  }
...
class ToolCallRequestedArgumentsSessionEventDataLegacySessionTimelineArguments extends ToolCallRequestedArguments {
  const ToolCallRequestedArgumentsSessionEventDataLegacySessionTimelineArguments(this.value) : super();
...
class ToolCallRequestedArgumentsSessionEventDataLegacySessionTimelineArguments2 extends ToolCallRequestedArguments {
  const ToolCallRequestedArgumentsSessionEventDataLegacySessionTimelineArguments2(this.value) : super();
...
class ToolCallRequested extends SessionEventDataLegacySessionTimeline {
  ...
  factory ToolCallRequested.fromJson(Map<String, dynamic> json) {
    ...
    final arguments = json['arguments'] == null
        ? null
        : ToolCallRequestedArguments.fromJson((json['arguments'] as Map).cast<String, dynamic>());
    remaining.remove('arguments');
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (value0 != null) {
      ...
      try {
        final context = constraintp0c0_0;
        final constraintp0v0_0 = SessionEventDataLegacySessionTimelineArguments.fromJson(
          (jsonp0 as Map).cast<String, dynamic>(),
        );
        final jsonp0c0b0 = constraintp0v0_0.toJson();
        final constraintp0c0b0c0_0 = context == null ? null : ValidationContext();
        var constraintp0c0b0m0_0 = false;
        try {
          final context = constraintp0c0b0c0_0;
          final constraintp0c0b0v0_0 = SessionEventDataLegacySessionTimelineArgumentsObject.fromJson(
            (jsonp0c0b0 as Map).cast<String, dynamic>(),
          );
          constraintp0c0b0m0_0 = true;
        } catch (_) {}
        final constraintp0c0b0c0_1 = context == null ? null : ValidationContext();
        var constraintp0c0b0m0_1 = false;
        try {
          final context = constraintp0c0b0c0_1;
          final constraintp0c0b0v0_1 = SessionEventDataLegacySessionTimelineArgumentsObject2.fromJson(
            (jsonp0c0b0 as Map).cast<String, dynamic>(),
          );
          constraintp0c0b0m0_1 = true;
        } catch (_) {}
        final constraintp0c0b0c0_2 = context == null ? null : ValidationContext();
        var constraintp0c0b0m0_2 = false;
        try {
          final context = constraintp0c0b0c0_2;
          final constraintp0c0b0v0_2 = SessionEventDataLegacySessionTimelineArgumentsObject3.fromJson(
            (jsonp0c0b0 as Map).cast<String, dynamic>(),
          );
          constraintp0c0b0m0_2 = true;
        } catch (_) {}
        final constraintp0c0b0c0_3 = context == null ? null : ValidationContext();
        var constraintp0c0b0m0_3 = false;
        try {
          final context = constraintp0c0b0c0_3;
          final constraintp0c0b0v0_3 = SessionEventDataLegacySessionTimelineArgumentsObject4.fromJson(
            (jsonp0c0b0 as Map).cast<String, dynamic>(),
          );
        ...
        if (context != null && constraintp0c0b0m0_0 && constraintp0c0b0c0_0 != null) {
          context.mergeFrom(constraintp0c0b0c0_0);
        }
        if (context != null && constraintp0c0b0m0_1 && constraintp0c0b0c0_1 != null) {
          context.mergeFrom(constraintp0c0b0c0_1);
        }
        if (context != null && constraintp0c0b0m0_2 && constraintp0c0b0c0_2 != null) {
          context.mergeFrom(constraintp0c0b0c0_2);
        }
        if (context != null && constraintp0c0b0m0_3 && constraintp0c0b0c0_3 != null) {
      ...
      try {
        final context = constraintp0c0_1;
        final constraintp0v0_1 = SessionEventDataLegacySessionTimelineArguments2.fromJson(
          (jsonp0 as Map).cast<String, dynamic>(),
        );
        final jsonp0c0b1 = constraintp0v0_1.toJson();
        final constraintp0c0b1c0_0 = context == null ? null : ValidationContext();
        var constraintp0c0b1m0_0 = false;
        try {
          final context = constraintp0c0b1c0_0;
          final constraintp0c0b1v0_0 = View.fromJson((jsonp0c0b1 as Map).cast<String, dynamic>());
          constraintp0c0b1v0_0.validate(pointer: ptr0, context: context);
          constraintp0c0b1m0_0 = true;
        } catch (_) {}
        final constraintp0c0b1c0_1 = context == null ? null : ValidationContext();
        var constraintp0c0b1m0_1 = false;
        try {
          final context = constraintp0c0b1c0_1;
          final constraintp0c0b1v0_1 = Create.fromJson((jsonp0c0b1 as Map).cast<String, dynamic>());
          constraintp0c0b1v0_1.validate(pointer: ptr0, context: context);
          constraintp0c0b1m0_1 = true;
        } catch (_) {}
        final constraintp0c0b1c0_2 = context == null ? null : ValidationContext();
        var constraintp0c0b1m0_2 = false;
        try {
          final context = constraintp0c0b1c0_2;
          final constraintp0c0b1v0_2 = StrReplace.fromJson((jsonp0c0b1 as Map).cast<String, dynamic>());
          constraintp0c0b1v0_2.validate(pointer: ptr0, context: context);
          constraintp0c0b1m0_2 = true;
        } catch (_) {}
        final constraintp0c0b1c0_3 = context == null ? null : ValidationContext();
        var constraintp0c0b1m0_3 = false;
        try {
          final context = constraintp0c0b1c0_3;
          final constraintp0c0b1v0_3 = Insert.fromJson((jsonp0c0b1 as Map).cast<String, dynamic>());
        ...
        if (context != null && constraintp0c0b1m0_0 && constraintp0c0b1c0_0 != null) {
          context.mergeFrom(constraintp0c0b1c0_0);
        }
        if (context != null && constraintp0c0b1m0_1 && constraintp0c0b1c0_1 != null) {
          context.mergeFrom(constraintp0c0b1c0_1);
        }
        if (context != null && constraintp0c0b1m0_2 && constraintp0c0b1c0_2 != null) {
          context.mergeFrom(constraintp0c0b1c0_2);
        }
        if (context != null && constraintp0c0b1m0_3 && constraintp0c0b1c0_3 != null) {
      ...
      final constraintp0matches0 = <bool>[constraintp0m0_0, constraintp0m0_1, constraintp0m0_2];
      if (!constraintp0matches0.any((value) => value)) {
        throwValidationError(
          ptr0,
          'anyOf',
    ...
    if (actualp9 != 'tool_call_requested') {
      throwValidationError(ptr9, 'const', "Expected value equal to 'tool_call_requested' but found " + actualp9 + '.');
    }
  }
}

class SessionEventDataLegacySessionTimelineArgumentsObject5 extends SessionEventDataLegacySessionTimelineArguments3 {
  ...
  factory SessionEventDataLegacySessionTimelineArgumentsObject5.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final async_ = json['async'] as bool?;
    remaining.remove('async');
    final command = json['command'] as String;
...
class SessionEventDataLegacySessionTimelineArgumentsObject6 extends SessionEventDataLegacySessionTimelineArguments3 {
  ...
  factory SessionEventDataLegacySessionTimelineArgumentsObject6.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final delay = (json['delay'] as num?)?.toDouble();
    remaining.remove('delay');
    final input = json['input'] as String;
...
class SessionEventDataLegacySessionTimelineArgumentsObject7 extends SessionEventDataLegacySessionTimelineArguments3 {
  const SessionEventDataLegacySessionTimelineArgumentsObject7({
    required this.delay,
    required this.sessionId,
  }) : super();

  factory SessionEventDataLegacySessionTimelineArgumentsObject7.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final delay = (json['delay'] as num).toDouble();
    remaining.remove('delay');
    final sessionId = json['sessionId'] as String;
...
class SessionEventDataLegacySessionTimelineArgumentsObject8 extends SessionEventDataLegacySessionTimelineArguments3 {
  const SessionEventDataLegacySessionTimelineArgumentsObject8({
    required this.sessionId,
  }) : super();

  factory SessionEventDataLegacySessionTimelineArgumentsObject8.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final sessionId = json['sessionId'] as String;
    remaining.remove('sessionId');
    final unmatched = Map<String, dynamic>.from(remaining);
...
sealed class SessionEventDataLegacySessionTimelineArguments3 {
  ...
  factory SessionEventDataLegacySessionTimelineArguments3.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final requiredMatches = <SessionEventDataLegacySessionTimelineArguments3 Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    if (keys.contains('command') && keys.contains('description')) {
      requiredMatches.add(SessionEventDataLegacySessionTimelineArgumentsObject5.fromJson);
      requiredMatchNames.add('SessionEventDataLegacySessionTimelineArgumentsObject5');
    }
    if (keys.contains('sessionId') && keys.contains('input')) {
      requiredMatches.add(SessionEventDataLegacySessionTimelineArgumentsObject6.fromJson);
      requiredMatchNames.add('SessionEventDataLegacySessionTimelineArgumentsObject6');
    }
    if (keys.contains('sessionId') && keys.contains('delay')) {
      requiredMatches.add(SessionEventDataLegacySessionTimelineArgumentsObject7.fromJson);
      requiredMatchNames.add('SessionEventDataLegacySessionTimelineArgumentsObject7');
    }
    if (keys.contains('sessionId')) {
      requiredMatches.add(SessionEventDataLegacySessionTimelineArgumentsObject8.fromJson);
      requiredMatchNames.add('SessionEventDataLegacySessionTimelineArgumentsObject8');
    }
    if (requiredMatches.length == 1) {
      return requiredMatches.single(json);
    }
...
sealed class SessionEventDataLegacySessionTimelineArguments4 {
  ...
  factory SessionEventDataLegacySessionTimelineArguments4.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final constMatches = <SessionEventDataLegacySessionTimelineArguments4 Function(Map<String, dynamic>)>[];
    final constMatchNames = <String>[];
    if (json['command'] == 'view') {
    ...
    final requiredMatches = <SessionEventDataLegacySessionTimelineArguments4 Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    if (keys.contains('command') && keys.contains('path')) {
  ...
  factory ToolCallCompletedArguments.fromJson(dynamic json) {
    if (json is Map<String, dynamic>)
      return ToolCallCompletedArgumentsSessionEventDataLegacySessionTimelineArguments3(
        SessionEventDataLegacySessionTimelineArguments3.fromJson((json as Map).cast<String, dynamic>()),
      );
    if (json is Map<String, dynamic>)
      return ToolCallCompletedArgumentsSessionEventDataLegacySessionTimelineArguments4(
        SessionEventDataLegacySessionTimelineArguments4.fromJson((json as Map).cast<String, dynamic>()),
      );
    throw ArgumentError('Invalid ToolCallCompletedArguments value type: ${json.runtimeType}');
  }
...
class ToolCallCompletedArgumentsSessionEventDataLegacySessionTimelineArguments3 extends ToolCallCompletedArguments {
  const ToolCallCompletedArgumentsSessionEventDataLegacySessionTimelineArguments3(this.value) : super();
...
class ToolCallCompletedArgumentsSessionEventDataLegacySessionTimelineArguments4 extends ToolCallCompletedArguments {
  const ToolCallCompletedArgumentsSessionEventDataLegacySessionTimelineArguments4(this.value) : super();
...
class Success extends ToolCallCompletedResult {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp3 != 'success') {
      throwValidationError(ptr3, 'const', "Expected value equal to 'success' but found " + actualp3 + '.');
    }
  }
}
...
class Failure extends ToolCallCompletedResult {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp2 = value2;
    if (actualp2 != 'failure') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'failure' but found " + actualp2 + '.');
    }
  }
}
...
class Rejected extends ToolCallCompletedResult {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp1 != 'rejected') {
      throwValidationError(ptr1, 'const', "Expected value equal to 'rejected' but found " + actualp1 + '.');
    }
  }
}
...
class Denied extends ToolCallCompletedResult {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp2 = value2;
    if (actualp2 != 'denied') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'denied' but found " + actualp2 + '.');
    }
  }
}
...
sealed class ToolCallCompletedResult {
  ...
  factory ToolCallCompletedResult.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final constMatches = <ToolCallCompletedResult Function(Map<String, dynamic>)>[];
    final constMatchNames = <String>[];
    ...
    final requiredMatches = <ToolCallCompletedResult Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    ...
    throw ArgumentError('No ToolCallCompletedResult variant matched heuristics (keys: ${sortedKeys.join(', ')}).');
  }
...
class ToolCallCompleted extends SessionEventDataLegacySessionTimeline {
  ...
  factory ToolCallCompleted.fromJson(Map<String, dynamic> json) {
    ...
    final arguments = json['arguments'] == null
        ? null
        : ToolCallCompletedArguments.fromJson((json['arguments'] as Map).cast<String, dynamic>());
    remaining.remove('arguments');
    final callId = json['callId'] as String;
    remaining.remove('callId');
    final intentionSummary = json['intentionSummary'] as String?;
    ...
    final name = json['name'] as String;
    remaining.remove('name');
    final result = ToolCallCompletedResult.fromJson((json['result'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (value0 != null) {
      ...
      try {
        final context = constraintp0c0_0;
        final constraintp0v0_0 = SessionEventDataLegacySessionTimelineArguments3.fromJson(
          (jsonp0 as Map).cast<String, dynamic>(),
        );
        final jsonp0c0b0 = constraintp0v0_0.toJson();
        final constraintp0c0b0c0_0 = context == null ? null : ValidationContext();
        ...
        try {
          final context = constraintp0c0b0c0_0;
          final constraintp0c0b0v0_0 = SessionEventDataLegacySessionTimelineArgumentsObject5.fromJson(
            (jsonp0c0b0 as Map).cast<String, dynamic>(),
          );
          constraintp0c0b0m0_0 = true;
        } catch (_) {}
        ...
        try {
          final context = constraintp0c0b0c0_1;
          final constraintp0c0b0v0_1 = SessionEventDataLegacySessionTimelineArgumentsObject6.fromJson(
            (jsonp0c0b0 as Map).cast<String, dynamic>(),
          );
          constraintp0c0b0m0_1 = true;
        } catch (_) {}
        ...
        try {
          final context = constraintp0c0b0c0_2;
          final constraintp0c0b0v0_2 = SessionEventDataLegacySessionTimelineArgumentsObject7.fromJson(
            (jsonp0c0b0 as Map).cast<String, dynamic>(),
          );
          constraintp0c0b0m0_2 = true;
        } catch (_) {}
        ...
        try {
          final context = constraintp0c0b0c0_3;
          final constraintp0c0b0v0_3 = SessionEventDataLegacySessionTimelineArgumentsObject8.fromJson(
            (jsonp0c0b0 as Map).cast<String, dynamic>(),
          );
          constraintp0c0b0m0_3 = true;
        } catch (_) {}
      ...
      try {
        final context = constraintp0c0_1;
        final constraintp0v0_1 = SessionEventDataLegacySessionTimelineArguments4.fromJson(
          (jsonp0 as Map).cast<String, dynamic>(),
        );
        final jsonp0c0b1 = constraintp0v0_1.toJson();
        final constraintp0c0b1c0_0 = context == null ? null : ValidationContext();
        ...
        try {
          final context = constraintp0c0b1c0_0;
          final constraintp0c0b1v0_0 = View2.fromJson((jsonp0c0b1 as Map).cast<String, dynamic>());
          constraintp0c0b1v0_0.validate(pointer: ptr0, context: context);
          constraintp0c0b1m0_0 = true;
        } catch (_) {}
        final constraintp0c0b1c0_1 = context == null ? null : ValidationContext();
        ...
        try {
          final context = constraintp0c0b1c0_1;
          final constraintp0c0b1v0_1 = Create2.fromJson((jsonp0c0b1 as Map).cast<String, dynamic>());
          constraintp0c0b1v0_1.validate(pointer: ptr0, context: context);
          constraintp0c0b1m0_1 = true;
        } catch (_) {}
        final constraintp0c0b1c0_2 = context == null ? null : ValidationContext();
        ...
        try {
          final context = constraintp0c0b1c0_2;
          final constraintp0c0b1v0_2 = StrReplace2.fromJson((jsonp0c0b1 as Map).cast<String, dynamic>());
          constraintp0c0b1v0_2.validate(pointer: ptr0, context: context);
          constraintp0c0b1m0_2 = true;
        } catch (_) {}
        final constraintp0c0b1c0_3 = context == null ? null : ValidationContext();
        ...
        try {
          final context = constraintp0c0b1c0_3;
          final constraintp0c0b1v0_3 = Insert2.fromJson((jsonp0c0b1 as Map).cast<String, dynamic>());
          constraintp0c0b1v0_3.validate(pointer: ptr0, context: context);
          constraintp0c0b1m0_3 = true;
        } catch (_) {}
        final constraintp0c0b1matches0 = <bool>[
    ...
    try {
      ...
      final constraintp6v0_0 = Success.fromJson((jsonp6 as Map).cast<String, dynamic>());
    ...
    try {
      ...
      final constraintp6v0_1 = Failure.fromJson((jsonp6 as Map).cast<String, dynamic>());
    ...
    try {
      ...
      final constraintp6v0_2 = Rejected.fromJson((jsonp6 as Map).cast<String, dynamic>());
    ...
    try {
      ...
      final constraintp6v0_3 = Denied.fromJson((jsonp6 as Map).cast<String, dynamic>());
      constraintp6v0_3.validate(pointer: ptr6, context: context);
      constraintp6m0_3 = true;
    } catch (_) {}
    final constraintp6matches0 = <bool>[constraintp6m0_0, constraintp6m0_1, constraintp6m0_2, constraintp6m0_3];
    ...
    if (actualp9 != 'tool_call_completed') {
      throwValidationError(ptr9, 'const', "Expected value equal to 'tool_call_completed' but found " + actualp9 + '.');
    }
  }
}
...
sealed class SessionEventDataLegacySessionTimeline {
  ...
  factory SessionEventDataLegacySessionTimeline.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final constMatches = <SessionEventDataLegacySessionTimeline Function(Map<String, dynamic>)>[];
    final constMatchNames = <String>[];
    ...
    final requiredMatches = <SessionEventDataLegacySessionTimeline Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    if (keys.contains('type') && keys.contains('text')) {
...
class SessionEventDataLegacySessionTimeline2 {
  ...
  factory SessionEventDataLegacySessionTimeline2.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final id = json['id'] as String;
    remaining.remove('id');
    final timestamp = json['timestamp'] as String;
...
class SessionImportLegacyDataLegacySession {
  ...
  factory SessionImportLegacyDataLegacySession.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final chatMessages = (json['chatMessages'] as List)
        .map((e) => SessionImportLegacyDataLegacySessionChatMessage.fromJson((e as Map).cast<String, dynamic>()))
        .toList();
    remaining.remove('chatMessages');
    final selectedModel = json['selectedModel'] == null
        ? null
        : SessionImportLegacyDataLegacySessionSelectedModelJson.fromJson(json['selectedModel'] as String);
    ...
    final timeline = (json['timeline'] as List)
        .map((e) => SessionImportLegacyDataLegacySessionTimelineItem.fromJson((e as Map).cast<String, dynamic>()))
        .toList();
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    for (var i = 0; i < lenp0; i++) {
      ...
      try {
        ...
        final constraintp0iv0_0 = Developer.fromJson((jsonp0i as Map).cast<String, dynamic>());
      ...
      try {
        ...
        final constraintp0iv0_1 = System.fromJson((jsonp0i as Map).cast<String, dynamic>());
      ...
      try {
        ...
        final constraintp0iv0_2 = User.fromJson((jsonp0i as Map).cast<String, dynamic>());
      ...
      try {
        ...
        final constraintp0iv0_3 = Assistant.fromJson((jsonp0i as Map).cast<String, dynamic>());
      ...
      try {
        ...
        final constraintp0iv0_4 = Tool.fromJson((jsonp0i as Map).cast<String, dynamic>());
      ...
      try {
        ...
        final constraintp0iv0_5 = Function2.fromJson((jsonp0i as Map).cast<String, dynamic>());
    ...
    for (var i = 0; i < lenp4; i++) {
      ...
      try {
        ...
        final constraintp4iv0_0 = SessionEventDataLegacySessionTimeline.fromJson(
          (jsonp4i as Map).cast<String, dynamic>(),
        );
        final jsonp4ic0b0 = constraintp4iv0_0.toJson();
        final constraintp4ic0b0c0_0 = context == null ? null : ValidationContext();
        var constraintp4ic0b0m0_0 = false;
        try {
          final context = constraintp4ic0b0c0_0;
          final constraintp4ic0b0v0_0 = Copilot.fromJson((jsonp4ic0b0 as Map).cast<String, dynamic>());
          constraintp4ic0b0v0_0.validate(pointer: itemPointer, context: context);
          constraintp4ic0b0m0_0 = true;
        } catch (_) {}
        final constraintp4ic0b0c0_1 = context == null ? null : ValidationContext();
        var constraintp4ic0b0m0_1 = false;
        try {
          final context = constraintp4ic0b0c0_1;
          final constraintp4ic0b0v0_1 = Error.fromJson((jsonp4ic0b0 as Map).cast<String, dynamic>());
          constraintp4ic0b0v0_1.validate(pointer: itemPointer, context: context);
          constraintp4ic0b0m0_1 = true;
        } catch (_) {}
        final constraintp4ic0b0c0_2 = context == null ? null : ValidationContext();
        var constraintp4ic0b0m0_2 = false;
        try {
          final context = constraintp4ic0b0c0_2;
          final constraintp4ic0b0v0_2 = Info.fromJson((jsonp4ic0b0 as Map).cast<String, dynamic>());
          constraintp4ic0b0v0_2.validate(pointer: itemPointer, context: context);
          constraintp4ic0b0m0_2 = true;
        } catch (_) {}
        final constraintp4ic0b0c0_3 = context == null ? null : ValidationContext();
        var constraintp4ic0b0m0_3 = false;
        try {
          final context = constraintp4ic0b0c0_3;
          final constraintp4ic0b0v0_3 = Warning.fromJson((jsonp4ic0b0 as Map).cast<String, dynamic>());
          constraintp4ic0b0v0_3.validate(pointer: itemPointer, context: context);
          constraintp4ic0b0m0_3 = true;
        } catch (_) {}
        final constraintp4ic0b0c0_4 = context == null ? null : ValidationContext();
        var constraintp4ic0b0m0_4 = false;
        try {
          final context = constraintp4ic0b0c0_4;
          final constraintp4ic0b0v0_4 = User2.fromJson((jsonp4ic0b0 as Map).cast<String, dynamic>());
          constraintp4ic0b0v0_4.validate(pointer: itemPointer, context: context);
          constraintp4ic0b0m0_4 = true;
        } catch (_) {}
        final constraintp4ic0b0c0_5 = context == null ? null : ValidationContext();
        var constraintp4ic0b0m0_5 = false;
        try {
          final context = constraintp4ic0b0c0_5;
          final constraintp4ic0b0v0_5 = ToolCallRequested.fromJson((jsonp4ic0b0 as Map).cast<String, dynamic>());
          constraintp4ic0b0v0_5.validate(pointer: itemPointer, context: context);
          constraintp4ic0b0m0_5 = true;
        } catch (_) {}
        final constraintp4ic0b0c0_6 = context == null ? null : ValidationContext();
        var constraintp4ic0b0m0_6 = false;
        try {
          final context = constraintp4ic0b0c0_6;
          final constraintp4ic0b0v0_6 = ToolCallCompleted.fromJson((jsonp4ic0b0 as Map).cast<String, dynamic>());
          constraintp4ic0b0v0_6.validate(pointer: itemPointer, context: context);
        ...
        if (context != null && constraintp4ic0b0m0_0 && constraintp4ic0b0c0_0 != null) {
          context.mergeFrom(constraintp4ic0b0c0_0);
        }
        if (context != null && constraintp4ic0b0m0_1 && constraintp4ic0b0c0_1 != null) {
          context.mergeFrom(constraintp4ic0b0c0_1);
        }
        if (context != null && constraintp4ic0b0m0_2 && constraintp4ic0b0c0_2 != null) {
          context.mergeFrom(constraintp4ic0b0c0_2);
        }
        if (context != null && constraintp4ic0b0m0_3 && constraintp4ic0b0c0_3 != null) {
          context.mergeFrom(constraintp4ic0b0c0_3);
        }
        if (context != null && constraintp4ic0b0m0_4 && constraintp4ic0b0c0_4 != null) {
          context.mergeFrom(constraintp4ic0b0c0_4);
        }
        if (context != null && constraintp4ic0b0m0_5 && constraintp4ic0b0c0_5 != null) {
          context.mergeFrom(constraintp4ic0b0c0_5);
        }
        if (context != null && constraintp4ic0b0m0_6 && constraintp4ic0b0c0_6 != null) {
      ...
      try {
        ...
        final constraintp4iv0_1 = SessionEventDataLegacySessionTimeline2.fromJson(
          (jsonp4i as Map).cast<String, dynamic>(),
        );
        constraintp4im0_1 = true;
      } catch (_) {}
      final constraintp4imatches0 = <bool>[constraintp4im0_0, constraintp4im0_1];
...
class SessionImportLegacy extends SessionEvent {
  ...
  factory SessionImportLegacy.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionImportLegacyData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.import_legacy') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'session.import_legacy' but found " + actualp5 + '.',
      );
    }
  }
}
...
class SessionHandoffData {
  ...
  factory SessionHandoffData.fromJson(Map<String, dynamic> json) {
    ...
    final repository = json['repository'] == null
        ? null
        : SessionHandoffDataRepository.fromJson((json['repository'] as Map).cast<String, dynamic>());
    remaining.remove('repository');
    final sourceType = SessionHandoffDataSourceTypeJson.fromJson(json['sourceType'] as String);
...
class SessionHandoff extends SessionEvent {
  ...
  factory SessionHandoff.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionHandoffData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.handoff') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.handoff' but found " + actualp5 + '.');
    }
  }
}
...
class SessionTruncationData {
  ...
  factory SessionTruncationData.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final messagesRemovedDuringTruncation = (json['messagesRemovedDuringTruncation'] as num).toDouble();
    remaining.remove('messagesRemovedDuringTruncation');
    final performedBy = json['performedBy'] as String;
    remaining.remove('performedBy');
    final postTruncationMessagesLength = (json['postTruncationMessagesLength'] as num).toDouble();
    remaining.remove('postTruncationMessagesLength');
    final postTruncationTokensInMessages = (json['postTruncationTokensInMessages'] as num).toDouble();
    remaining.remove('postTruncationTokensInMessages');
    final preTruncationMessagesLength = (json['preTruncationMessagesLength'] as num).toDouble();
    remaining.remove('preTruncationMessagesLength');
    final preTruncationTokensInMessages = (json['preTruncationTokensInMessages'] as num).toDouble();
    remaining.remove('preTruncationTokensInMessages');
    final tokenLimit = (json['tokenLimit'] as num).toDouble();
    remaining.remove('tokenLimit');
    final tokensRemovedDuringTruncation = (json['tokensRemovedDuringTruncation'] as num).toDouble();
...
class SessionTruncation extends SessionEvent {
  ...
  factory SessionTruncation.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionTruncationData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.truncation') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.truncation' but found " + actualp5 + '.');
    }
  }
}
...
class SessionSnapshotRewindData {
  ...
  factory SessionSnapshotRewindData.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final eventsRemoved = (json['eventsRemoved'] as num).toDouble();
...
class SessionSnapshotRewind extends SessionEvent {
  ...
  factory SessionSnapshotRewind.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionSnapshotRewindData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.snapshot_rewind') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'session.snapshot_rewind' but found " + actualp5 + '.',
      );
    }
  }
}
...
class SessionUsageInfoData {
  ...
  factory SessionUsageInfoData.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final currentTokens = (json['currentTokens'] as num).toDouble();
    remaining.remove('currentTokens');
    final messagesLength = (json['messagesLength'] as num).toDouble();
...
class SessionUsageInfo extends SessionEvent {
  ...
  factory SessionUsageInfo.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionUsageInfoData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.usage_info') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'session.usage_info' but found " + actualp5 + '.');
    }
  }
}
...
class SessionCompactionStart extends SessionEvent {
  ...
  factory SessionCompactionStart.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionCompactionStartData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.compaction_start') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'session.compaction_start' but found " + actualp5 + '.',
      );
    }
  }
}
...
class SessionCompactionCompleteDataCompactionTokensUsed {
  ...
  factory SessionCompactionCompleteDataCompactionTokensUsed.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final cachedInput = (json['cachedInput'] as num).toDouble();
    remaining.remove('cachedInput');
    final input = (json['input'] as num).toDouble();
    remaining.remove('input');
    final output = (json['output'] as num).toDouble();
...
class SessionCompactionCompleteData {
  ...
  factory SessionCompactionCompleteData.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final checkpointNumber = (json['checkpointNumber'] as num?)?.toDouble();
    ...
    final messagesRemoved = (json['messagesRemoved'] as num?)?.toDouble();
    remaining.remove('messagesRemoved');
    final postCompactionTokens = (json['postCompactionTokens'] as num?)?.toDouble();
    remaining.remove('postCompactionTokens');
    final preCompactionMessagesLength = (json['preCompactionMessagesLength'] as num?)?.toDouble();
    remaining.remove('preCompactionMessagesLength');
    final preCompactionTokens = (json['preCompactionTokens'] as num?)?.toDouble();
    ...
    final tokensRemoved = (json['tokensRemoved'] as num?)?.toDouble();
  ...
  Map<String, dynamic> toJson() {
    ...
    if (compactionTokensUsed != null) map['compactionTokensUsed'] = compactionTokensUsed!.toJson();
    if (error != null) map['error'] = error;
    if (messagesRemoved != null) map['messagesRemoved'] = messagesRemoved;
    if (postCompactionTokens != null) map['postCompactionTokens'] = postCompactionTokens;
    if (preCompactionMessagesLength != null) map['preCompactionMessagesLength'] = preCompactionMessagesLength;
    if (preCompactionTokens != null) map['preCompactionTokens'] = preCompactionTokens;
    map['success'] = success;
...
class SessionCompactionComplete extends SessionEvent {
  ...
  factory SessionCompactionComplete.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SessionCompactionCompleteData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'session.compaction_complete') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'session.compaction_complete' but found " + actualp5 + '.',
      );
    }
  }
}
...
class File2 extends UserMessageDataAttachment {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp2 = value2;
    if (actualp2 != 'file') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'file' but found " + actualp2 + '.');
    }
  }
}
...
class Directory extends UserMessageDataAttachment {
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp2 != 'directory') {
      throwValidationError(ptr2, 'const', "Expected value equal to 'directory' but found " + actualp2 + '.');
    }
  }
}
...
class SelectionSelectionEnd {
  ...
  factory SelectionSelectionEnd.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final character = (json['character'] as num).toDouble();
    remaining.remove('character');
    final line = (json['line'] as num).toDouble();
...
class SessionStartData {
  ...
  factory SessionStartData.fromJson(Map<String, dynamic> json) {
    ...
    final context = json['context'] == null
        ? null
        : SessionStartDataContext.fromJson((json['context'] as Map).cast<String, dynamic>());
    remaining.remove('context');
    ...
    final startTime = json['startTime'] as String;
    remaining.remove('startTime');
    final version = (json['version'] as num).toDouble();
...
class SelectionSelection {
  ...
  factory SelectionSelection.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final end = SelectionSelectionEnd.fromJson((json['end'] as Map).cast<String, dynamic>());
    remaining.remove('end');
    final start = SelectionSelectionStart.fromJson((json['start'] as Map).cast<String, dynamic>());
...
class Selection extends UserMessageDataAttachment {
  ...
  factory Selection.fromJson(Map<String, dynamic> json) {
    ...
    final selection = SelectionSelection.fromJson((json['selection'] as Map).cast<String, dynamic>());
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp4 != 'selection') {
      throwValidationError(ptr4, 'const', "Expected value equal to 'selection' but found " + actualp4 + '.');
    }
  }
}
...
sealed class UserMessageDataAttachment {
  ...
  factory UserMessageDataAttachment.fromJson(Map<String, dynamic> json) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final constMatches = <UserMessageDataAttachment Function(Map<String, dynamic>)>[];
    final constMatchNames = <String>[];
    if (json['type'] == 'file') {
    ...
    final requiredMatches = <UserMessageDataAttachment Function(Map<String, dynamic>)>[];
    final requiredMatchNames = <String>[];
    if (keys.contains('type') && keys.contains('path') && keys.contains('displayName')) {
    ...
    throw ArgumentError('No UserMessageDataAttachment variant matched heuristics (keys: ${sortedKeys.join(', ')}).');
  }
...
class UserMessageData {
  ...
  factory UserMessageData.fromJson(Map<String, dynamic> json) {
    ...
    final attachments = json['attachments'] == null
        ...
        : (json['attachments'] as List)
              .map((e) => UserMessageDataAttachment.fromJson((e as Map).cast<String, dynamic>()))
              .toList();
  ...
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (attachments != null) map['attachments'] = attachments!.map((e) => e.toJson()).toList();
    map['content'] = content;
    if (source != null) map['source'] = source;
    if (transformedContent != null) map['transformedContent'] = transformedContent;
    return map;
  }
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (value0 != null) {
      ...
      for (var i = 0; i < lenp0; i++) {
        ...
        try {
          final context = constraintp0ic0_0;
          final constraintp0iv0_0 = File2.fromJson((jsonp0i as Map).cast<String, dynamic>());
          constraintp0iv0_0.validate(pointer: itemPointer, context: context);
          constraintp0im0_0 = true;
        } catch (_) {}
        final constraintp0ic0_1 = context == null ? null : ValidationContext();
        ...
        try {
          final context = constraintp0ic0_1;
          final constraintp0iv0_1 = Directory.fromJson((jsonp0i as Map).cast<String, dynamic>());
          constraintp0iv0_1.validate(pointer: itemPointer, context: context);
          constraintp0im0_1 = true;
        } catch (_) {}
        final constraintp0ic0_2 = context == null ? null : ValidationContext();
        ...
        try {
          final context = constraintp0ic0_2;
          final constraintp0iv0_2 = Selection.fromJson((jsonp0i as Map).cast<String, dynamic>());
          constraintp0iv0_2.validate(pointer: itemPointer, context: context);
          constraintp0im0_2 = true;
        } catch (_) {}
        final constraintp0imatches0 = <bool>[constraintp0im0_0, constraintp0im0_1, constraintp0im0_2];
        if (!constraintp0imatches0.any((value) => value)) {
          throwValidationError(
            itemPointer,
            'anyOf',
...
class UserMessage extends SessionEvent {
  ...
  factory UserMessage.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = UserMessageData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'user.message') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'user.message' but found " + actualp5 + '.');
    }
  }
}
...
class PendingMessagesModified extends SessionEvent {
  ...
  factory PendingMessagesModified.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = PendingMessagesModifiedData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'pending_messages.modified') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'pending_messages.modified' but found " + actualp5 + '.',
      );
    }
  }
}
...
class AssistantTurnStart extends SessionEvent {
  ...
  factory AssistantTurnStart.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AssistantTurnStartData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'assistant.turn_start') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'assistant.turn_start' but found " + actualp5 + '.');
    }
  }
}
...
class AssistantIntent extends SessionEvent {
  ...
  factory AssistantIntent.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AssistantIntentData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'assistant.intent') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'assistant.intent' but found " + actualp5 + '.');
    }
  }
}
...
class AssistantReasoning extends SessionEvent {
  ...
  factory AssistantReasoning.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AssistantReasoningData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'assistant.reasoning') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'assistant.reasoning' but found " + actualp5 + '.');
    }
  }
}
...
class AssistantReasoningDelta extends SessionEvent {
  ...
  factory AssistantReasoningDelta.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AssistantReasoningDeltaData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'assistant.reasoning_delta') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'assistant.reasoning_delta' but found " + actualp5 + '.',
      );
    }
  }
}
...
class AssistantMessageDataToolRequest {
  ...
  factory AssistantMessageDataToolRequest.fromJson(Map<String, dynamic> json) {
    ...
    final type = json['type'] == null ? null : AssistantMessageDataToolRequestTypeJson.fromJson(json['type'] as String);
    remaining.remove('type');
    final unmatched = Map<String, dynamic>.from(remaining);
    if (unmatched.isNotEmpty) {
      final unexpected = unmatched.keys.join(', ');
...
class AssistantMessageData {
  ...
  factory AssistantMessageData.fromJson(Map<String, dynamic> json) {
    ...
    final toolRequests = json['toolRequests'] == null
        ...
        : (json['toolRequests'] as List)
              .map((e) => AssistantMessageDataToolRequest.fromJson((e as Map).cast<String, dynamic>()))
              .toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    if (toolRequests != null) map['toolRequests'] = toolRequests!.map((e) => e.toJson()).toList();
    return map;
  }
...
class AssistantMessage extends SessionEvent {
  ...
  factory AssistantMessage.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AssistantMessageData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'assistant.message') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'assistant.message' but found " + actualp5 + '.');
    }
  }
}
...
class AssistantMessageDeltaData {
  ...
  factory AssistantMessageDeltaData.fromJson(Map<String, dynamic> json) {
    ...
    final parentToolCallId = json['parentToolCallId'] as String?;
    remaining.remove('parentToolCallId');
    final totalResponseSizeBytes = (json['totalResponseSizeBytes'] as num?)?.toDouble();
  ...
  Map<String, dynamic> toJson() {
    ...
    map['messageId'] = messageId;
    if (parentToolCallId != null) map['parentToolCallId'] = parentToolCallId;
    if (totalResponseSizeBytes != null) map['totalResponseSizeBytes'] = totalResponseSizeBytes;
    return map;
  }
...
class AssistantMessageDelta extends SessionEvent {
  ...
  factory AssistantMessageDelta.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AssistantMessageDeltaData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'assistant.message_delta') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'assistant.message_delta' but found " + actualp5 + '.',
      );
    }
  }
}
...
class AssistantTurnEnd extends SessionEvent {
  ...
  factory AssistantTurnEnd.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AssistantTurnEndData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'assistant.turn_end') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'assistant.turn_end' but found " + actualp5 + '.');
    }
  }
}
...
class AssistantUsageDataQuotaSnapshotsAdditionalProperty {
  ...
  factory AssistantUsageDataQuotaSnapshotsAdditionalProperty.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final entitlementRequests = (json['entitlementRequests'] as num).toDouble();
    ...
    final overage = (json['overage'] as num).toDouble();
    remaining.remove('overage');
    final overageAllowedWithExhaustedQuota = json['overageAllowedWithExhaustedQuota'] as bool;
    remaining.remove('overageAllowedWithExhaustedQuota');
    final remainingPercentage = (json['remainingPercentage'] as num).toDouble();
    remaining.remove('remainingPercentage');
    final resetDate = json['resetDate'] as String?;
    remaining.remove('resetDate');
    final usageAllowedWithExhaustedQuota = json['usageAllowedWithExhaustedQuota'] as bool;
    remaining.remove('usageAllowedWithExhaustedQuota');
    final usedRequests = (json['usedRequests'] as num).toDouble();
...
class AssistantUsageDataQuotaSnapshots {
  ...
  factory AssistantUsageDataQuotaSnapshots.fromJson(Map<String, dynamic> json) {
    ...
    Map<String, AssistantUsageDataQuotaSnapshotsAdditionalProperty>? additionalPropertiesValue;
    if (unmatched.isNotEmpty) {
      final additionalPropertiesMap = <String, AssistantUsageDataQuotaSnapshotsAdditionalProperty>{};
      for (final entry in unmatched.entries) {
        final value = entry.value;
        additionalPropertiesMap[entry.key] = AssistantUsageDataQuotaSnapshotsAdditionalProperty.fromJson(
  ...
  final Map<String, AssistantUsageDataQuotaSnapshotsAdditionalProperty>? additionalProperties;
...
class AssistantUsageData {
  ...
  factory AssistantUsageData.fromJson(Map<String, dynamic> json) {
    ...
    final cacheReadTokens = (json['cacheReadTokens'] as num?)?.toDouble();
    remaining.remove('cacheReadTokens');
    final cacheWriteTokens = (json['cacheWriteTokens'] as num?)?.toDouble();
    ...
    final inputTokens = (json['inputTokens'] as num?)?.toDouble();
    remaining.remove('inputTokens');
    final model = json['model'] as String;
    remaining.remove('model');
    final outputTokens = (json['outputTokens'] as num?)?.toDouble();
    ...
    final quotaSnapshots = json['quotaSnapshots'] == null
        ? null
        : AssistantUsageDataQuotaSnapshots.fromJson((json['quotaSnapshots'] as Map).cast<String, dynamic>());
  ...
  Map<String, dynamic> toJson() {
    ...
    if (quotaSnapshots != null) map['quotaSnapshots'] = quotaSnapshots!.toJson();
    return map;
  }
...
class AssistantUsage extends SessionEvent {
  ...
  factory AssistantUsage.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AssistantUsageData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'assistant.usage') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'assistant.usage' but found " + actualp5 + '.');
    }
  }
}
...
class Abort extends SessionEvent {
  ...
  factory Abort.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = AbortData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    final actualp5 = value5;
    if (actualp5 != 'abort') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'abort' but found " + actualp5 + '.');
    }
  }
}
...
class ToolUserRequested extends SessionEvent {
  ...
  factory ToolUserRequested.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = ToolUserRequestedData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'tool.user_requested') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'tool.user_requested' but found " + actualp5 + '.');
    }
  }
}
...
class ToolExecutionStart extends SessionEvent {
  ...
  factory ToolExecutionStart.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = ToolExecutionStartData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'tool.execution_start') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'tool.execution_start' but found " + actualp5 + '.');
    }
  }
}
...
class ToolExecutionPartialResult extends SessionEvent {
  ...
  factory ToolExecutionPartialResult.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = ToolExecutionPartialResultData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'tool.execution_partial_result') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'tool.execution_partial_result' but found " + actualp5 + '.',
      );
    }
  }
}
...
class ToolExecutionProgress extends SessionEvent {
  ...
  factory ToolExecutionProgress.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = ToolExecutionProgressData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'tool.execution_progress') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'tool.execution_progress' but found " + actualp5 + '.',
      );
    }
  }
}
...
class ToolExecutionCompleteDataToolTelemetry {
  ...
  factory ToolExecutionCompleteDataToolTelemetry.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    var unmatched = Map<String, dynamic>.from(remaining);
...
class ToolExecutionCompleteData {
  ...
  factory ToolExecutionCompleteData.fromJson(Map<String, dynamic> json) {
    ...
    final error = json['error'] == null
        ? null
        : ToolExecutionCompleteDataError.fromJson((json['error'] as Map).cast<String, dynamic>());
    remaining.remove('error');
    ...
    final result = json['result'] == null
        ? null
        : ToolExecutionCompleteDataResult.fromJson((json['result'] as Map).cast<String, dynamic>());
    remaining.remove('result');
    final success = json['success'] as bool;
    remaining.remove('success');
    final toolCallId = json['toolCallId'] as String;
    ...
    final toolTelemetry = json['toolTelemetry'] == null
        ? null
        : ToolExecutionCompleteDataToolTelemetry.fromJson((json['toolTelemetry'] as Map).cast<String, dynamic>());
...
class ToolExecutionComplete extends SessionEvent {
  ...
  factory ToolExecutionComplete.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = ToolExecutionCompleteData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'tool.execution_complete') {
      throwValidationError(
        ptr5,
        'const',
        "Expected value equal to 'tool.execution_complete' but found " + actualp5 + '.',
      );
    }
  }
}
...
class SkillInvoked extends SessionEvent {
  ...
  factory SkillInvoked.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SkillInvokedData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'skill.invoked') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'skill.invoked' but found " + actualp5 + '.');
    }
  }
}
...
class SubagentStarted extends SessionEvent {
  ...
  factory SubagentStarted.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SubagentStartedData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'subagent.started') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'subagent.started' but found " + actualp5 + '.');
    }
  }
}
...
class SubagentCompleted extends SessionEvent {
  ...
  factory SubagentCompleted.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SubagentCompletedData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'subagent.completed') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'subagent.completed' but found " + actualp5 + '.');
    }
  }
}
...
class SubagentFailed extends SessionEvent {
  ...
  factory SubagentFailed.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SubagentFailedData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'subagent.failed') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'subagent.failed' but found " + actualp5 + '.');
    }
  }
}
...
class SubagentSelectedData {
  ...
  factory SubagentSelectedData.fromJson(Map<String, dynamic> json) {
    ...
    final agentName = json['agentName'] as String;
    remaining.remove('agentName');
    final tools = json['tools'] == null ? null : (json['tools'] as List).map((e) => e as String).toList();
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (value2 != null) {
      ...
      try {
        final context = constraintp2c0_0;
        final constraintp2v0_0 = (jsonp2 as List).map((e) => e as String).toList();
        constraintp2m0_0 = true;
      } catch (_) {}
      final constraintp2c0_1 = context == null ? null : ValidationContext();
      var constraintp2m0_1 = false;
...
class SubagentSelected extends SessionEvent {
  ...
  factory SubagentSelected.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SubagentSelectedData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'subagent.selected') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'subagent.selected' but found " + actualp5 + '.');
    }
  }
}
...
class HookStart extends SessionEvent {
  ...
  factory HookStart.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = HookStartData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'hook.start') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'hook.start' but found " + actualp5 + '.');
    }
  }
}
...
class HookEndData {
  ...
  factory HookEndData.fromJson(Map<String, dynamic> json) {
    ...
    final error = json['error'] == null
        ? null
        : HookEndDataError.fromJson((json['error'] as Map).cast<String, dynamic>());
    remaining.remove('error');
    final hookInvocationId = json['hookInvocationId'] as String;
    remaining.remove('hookInvocationId');
    final hookType = json['hookType'] as String;
...
class HookEnd extends SessionEvent {
  ...
  factory HookEnd.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = HookEndData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'hook.end') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'hook.end' but found " + actualp5 + '.');
    }
  }
}
...
class SystemMessageDataMetadataVariables {
  ...
  factory SystemMessageDataMetadataVariables.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    var unmatched = Map<String, dynamic>.from(remaining);
    Map<String, dynamic>? additionalPropertiesValue;
    if (unmatched.isNotEmpty) {
...
class SystemMessageDataMetadata {
  ...
  factory SystemMessageDataMetadata.fromJson(Map<String, dynamic> json) {
    ...
    final variables = json['variables'] == null
        ? null
        : SystemMessageDataMetadataVariables.fromJson((json['variables'] as Map).cast<String, dynamic>());
...
class SystemMessageData {
  ...
  factory SystemMessageData.fromJson(Map<String, dynamic> json) {
    ...
    final metadata = json['metadata'] == null
        ? null
        : SystemMessageDataMetadata.fromJson((json['metadata'] as Map).cast<String, dynamic>());
...
class SystemMessage extends SessionEvent {
  ...
  factory SystemMessage.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final data = SystemMessageData.fromJson((json['data'] as Map).cast<String, dynamic>());
    remaining.remove('data');
    final ephemeral = json['ephemeral'] as bool?;
    remaining.remove('ephemeral');
    final id = json['id'] as String;
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (actualp5 != 'system.message') {
      throwValidationError(ptr5, 'const', "Expected value equal to 'system.message' but found " + actualp5 + '.');
    }
  }
}
...
extension SessionImportLegacyDataLegacySessionSelectedModelJson on SessionImportLegacyDataLegacySessionSelectedModel {
  String toJson() => const {
    SessionImportLegacyDataLegacySessionSelectedModel.claudeSonnet45: 'claude-sonnet-4.5',
    SessionImportLegacyDataLegacySessionSelectedModel.claudeHaiku45: 'claude-haiku-4.5',
    SessionImportLegacyDataLegacySessionSelectedModel.claudeOpus45: 'claude-opus-4.5',
    SessionImportLegacyDataLegacySessionSelectedModel.claudeSonnet4: 'claude-sonnet-4',
    SessionImportLegacyDataLegacySessionSelectedModel.gemini3ProPreview: 'gemini-3-pro-preview',
    SessionImportLegacyDataLegacySessionSelectedModel.gpt52Codex: 'gpt-5.2-codex',
    SessionImportLegacyDataLegacySessionSelectedModel.gpt52: 'gpt-5.2',
    SessionImportLegacyDataLegacySessionSelectedModel.gpt51CodexMax: 'gpt-5.1-codex-max',
    SessionImportLegacyDataLegacySessionSelectedModel.gpt51Codex: 'gpt-5.1-codex',
    ...
    SessionImportLegacyDataLegacySessionSelectedModel.gpt51CodexMini: 'gpt-5.1-codex-mini',
  ...
  static SessionImportLegacyDataLegacySessionSelectedModel fromJson(String value) => const {
    'claude-sonnet-4.5': SessionImportLegacyDataLegacySessionSelectedModel.claudeSonnet45,
    'claude-haiku-4.5': SessionImportLegacyDataLegacySessionSelectedModel.claudeHaiku45,
    'claude-opus-4.5': SessionImportLegacyDataLegacySessionSelectedModel.claudeOpus45,
    'claude-sonnet-4': SessionImportLegacyDataLegacySessionSelectedModel.claudeSonnet4,
    'gemini-3-pro-preview': SessionImportLegacyDataLegacySessionSelectedModel.gemini3ProPreview,
    'gpt-5.2-codex': SessionImportLegacyDataLegacySessionSelectedModel.gpt52Codex,
    'gpt-5.2': SessionImportLegacyDataLegacySessionSelectedModel.gpt52,
    'gpt-5.1-codex-max': SessionImportLegacyDataLegacySessionSelectedModel.gpt51CodexMax,
    'gpt-5.1-codex': SessionImportLegacyDataLegacySessionSelectedModel.gpt51Codex,
    ...
    'gpt-5.1-codex-mini': SessionImportLegacyDataLegacySessionSelectedModel.gpt51CodexMini,
...
extension AssistantMessageDataToolRequestTypeJson on AssistantMessageDataToolRequestType {
  String toJson() => const {
...
SessionEvent sessionEventFromJson(String str) => SessionEvent.fromJson(json.decode(str) as Map<String, dynamic>);
